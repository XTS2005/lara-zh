...
struct DecryptView: View {
        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    HeaderLabel(text: "已安装的应用", icon: "app.badge")
                }
            }
    ...
    func startDecrypt(_ app: DecryptApp) {
        ...
        guard mgr.dsready else { errormsg = "DarkSword 未就绪，请先运行漏洞。"; return }
    ...
    func doDecrypt(_ app: DecryptApp, pid: pid_t) {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            do {
                ...
                DispatchQueue.main.async {
                    decryptingbid = nil
                    errormsg = "移动应用 bundle 失败：\(error.localizedDescription)"
